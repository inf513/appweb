<script type="text/javascript" src="js/transferenciaEquipo.js"></script>
<!--AQUI SOLO TENGO 12 COLUMNAS PARA REPARTIR-->
	<div class="row">
		<div class="col-sm-12">
			<center>
				<h3>TRANSFERENCIA DE EQUIPOS PESADOS</h3>
			</center>
		</div>
	</div>
	...
	<div class="panel panel-danger">
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="hidden" id = 'TFPkTransfEquipo' value = "<?= ($edicion) ? $transferencia->pktransfequipo : '0';?>" >
		...
		<div class="panel panel-primary">
		  	<div class="panel-heading">Detalle de Transferencia de Equipo</div>
		  	<div class="panel-body">
				...
				<div class="panel panel-danger">
					<div class="panel-body">
						<div class="form-group">
							...
							<label class="col-sm-1 control-label" for="DTfkEquipo">Equipo</label>
							<div class="col-sm-2">
								<input type="text" onblur="getEquipo()" class="form-control" name="DTfkEquipo" id="DTfkEquipo" value= "0"/>
							</div>
							<label class="col-sm-6 text-left" id="DTNombreEqui">---</label>

						</div>
            <div class="form-gruop">
              <label class="col-sm-3 control-label" for="DTHmto">Horometro</label>
							<div class="col-sm-9">
							...
							<?php
								if($edicion){
									foreach ($detalles as $detalle) {
										echo "<tr>";
											echo "<td>" . $detalle->pkdettransfequipo . "</td>";
											echo "<td>" . $detalle->fktransfequipo . "</td>";
											echo "<td>" . $detalle->item . "</td>";
											echo "<td>" . $detalle->fkequipo	. "</td>";
											echo "<td>" . $detalle->equipo	. "</td>";
                      echo "<td>" . $detalle->hmto	. "</td>";
											echo "<td>" . $detalle->observacion	. "</td>";
									    	echo "<td><a href='#' onclick=\"editarDetalle('".$detalle->pkdettransfequipo."')\"><span class='glyphicon glyphicon-edit' data-toggle='tooltip' title='Editar'></span></a></td>";
								    		echo "<td><a href='#' onclick=\"eliminarDetalle('".$detalle->pkdettransfequipo . "','" . $detalle->equipo . "')\"><span class='glyphicon glyphicon-trash' data-toggle='tooltip' title='Eliminar'></span></a></td>";
										echo "</tr>";
									}
								}
							?>
