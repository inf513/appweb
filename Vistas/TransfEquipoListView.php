			...
			<tbody>
				...
				?>
						<tr>
						    ...
						    <?php
						    		echo "<td><a href='#' onclick=\"editar('" . $transfer->pktransfequipo . "')\"><span class='glyphicon glyphicon-edit' data-toggle='tooltip' title='Editar'></span></a></td>";
						    		echo "<td><a href='#' onclick=\"eliminar('". $transfer->pktransfequipo . "','" . $transfer->data . "')\"><span class='glyphicon glyphicon-trash' data-toggle='tooltip' title='Eliminar'></span></a></td>";
						    ?>
						</tr>
		<?php
					}
